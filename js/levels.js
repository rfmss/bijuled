...
var CHAPTERS = [{
  ...
  id: 3,
  name: 'Desafios Prismáticos',
  levels: [21, 30],
  color: '#8e24aa'
}, {
  id: 4,
  name: 'Tempestade Radiante',
  levels: [31, 40],
  color: '#e53935'
}, {
  id: 5,
  name: 'Maestria Diamante',
  levels: [41, 50],
  color: '#00bcd4'
}];
...
function makeLevel(id, opts) {
  return {
    ...
    starThresholds: opts.stars || [Math.floor((opts.objective && opts.objective.target || 0) * 0.5), Math.floor((opts.objective && opts.objective.target || 0) * 0.8), opts.objective && opts.objective.target || 0]
  };
}
var LEVELS = [
...
makeLevel(31, {
  ...
  moves: 16,
  gemTypes: 6,
  blocked: [[0, 1], [0, 3], [0, 5], [0, 7], [1, 0], [1, 2], [1, 4], [1, 6], [6, 1], [6, 3], [6, 5], [6, 7], [7, 0], [7, 2], [7, 4], [7, 6]],
  ...
  moves: 14,
  gemTypes: 6,
  blocked: [[0, 0], [0, 7], [7, 0], [7, 7], [1, 1], [1, 6], [6, 1], [6, 6], [3, 3], [3, 4], [4, 3], [4, 4]],
  ...
  moves: 15,
  gemTypes: 6,
  blocked: [[0, 3], [0, 4], [3, 0], [4, 0], [3, 7], [4, 7], [7, 3], [7, 4], [2, 2], [2, 5], [5, 2], [5, 5], [3, 3], [4, 4]],
  ...
  time: 60,
  gemTypes: 6,
  blocked: [[0, 0], [0, 7], [7, 0], [7, 7], [1, 1], [1, 6], [6, 1], [6, 6], [2, 2], [2, 5], [5, 2], [5, 5], [3, 3], [3, 4], [4, 3], [4, 4]],
...
makeLevel(41, {
  ...
  moves: 14,
  gemTypes: 6,
  blocked: [[0, 0], [0, 1], [0, 6], [0, 7], [1, 0], [6, 0], [1, 7], [6, 7], [7, 0], [7, 1], [7, 6], [7, 7], [3, 3], [4, 4]],
  ...
  moves: 14,
  gemTypes: 6,
  blocked: [[0, 2], [0, 5], [2, 0], [2, 7], [5, 0], [5, 7], [7, 2], [7, 5], [1, 3], [1, 4], [6, 3], [6, 4], [3, 1], [4, 1], [3, 6], [4, 6], [3, 3], [4, 4]],
  ...
  moves: 13,
  gemTypes: 6,
  blocked: [[0, 0], [0, 3], [0, 4], [0, 7], [3, 0], [4, 0], [3, 7], [4, 7], [7, 0], [7, 3], [7, 4], [7, 7], [2, 2], [5, 5], [2, 5], [5, 2]],
  ...
  moves: 13,
  gemTypes: 6,
  blocked: [[0, 0], [0, 1], [0, 6], [0, 7], [1, 0], [1, 7], [6, 0], [6, 7], [7, 0], [7, 1], [7, 6], [7, 7], [2, 2], [2, 5], [5, 2], [5, 5], [3, 3], [4, 4], [3, 4], [4, 3]],
  ...
  time: 120,
  gemTypes: 6,
  blocked: [[0, 0], [0, 7], [7, 0], [7, 7], [0, 3], [0, 4], [7, 3], [7, 4], [3, 0], [4, 0], [3, 7], [4, 7]],
...
function getChapterForLevel(levelId) {
  return CHAPTERS.find(function (c) {
    return levelId >= c.levels[0] && levelId <= c.levels[1];
  });
}
...
var Progress = {
  ...
  getLevelStars: function getLevelStars(id) {
    return this.data.stars && this.data.stars[id] || 0;
  },
  setLevelStars: function setLevelStars(id, stars) {
    var prev = this.getLevelStars(id);
    if (stars > prev) {
